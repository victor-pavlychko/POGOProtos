POGOProtos [![Build Status](https://travis-ci.org/Furtif/POGOProtos.svg?branch=master)](https://travis-ci.org/Furtif/POGOProtos) [![Maintainability](https://api.codeclimate.com/v1/badges/f4fbd03daa49a667d1b7/maintainability)](https://codeclimate.com/github/Furtif/POGOProtos/maintainability) [![Test Coverage](https://api.codeclimate.com/v1/badges/f4fbd03daa49a667d1b7/test_coverage)](https://codeclimate.com/github/Furtif/POGOProtos/test_coverage)
===================
...
Current recommended protoc version: "Protocol Buffers v3.6.0".
...
|--------------|---------------|---------------|---------------------------|
| 2.29.0       | 0.109.1       | 1.79.1        |                           |
| 2.28.0       | 0.107.1       | 1.77.1        | Updated protobuf to 3.6.0 |
